            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
              ...
              <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                  ...
                  <a class="nav-item nav-link" href="index.php?p=posts.category&id=1"><i class="fas fa-book"></i> Romans</a>
                  <?php
                      if (!isset($_SESSION['auth'])) {
                          echo '<a class="nav-item nav-link custom-link" href="index.php?p=users.login"> <i class="fas fa-sign-in-alt"></i> Connexion</a>';
                      } else {
                          echo '<a class="nav-item nav-link custom-link" href="index.php?p=admin.posts.index"><i class="fas fa-cogs"></i> Admin</a>';
                      }
                   ?>
                </div>
              </div>
